...
Hooks.once('init', () => {
    ...
    game.settings.register(RagnaroksRunar.ID, "unreadData", {
        scope: "client", config: false, type: Object, default: { counts: {}, lastRead: {} }
    });
    
    game.settings.register(RagnaroksRunar.ID, "favorites", {
        scope: "client", config: false, type: Array, default: []
    });
    
    game.settings.register(RagnaroksRunar.ID, "mutedConversations", {
        scope: "client", config: false, type: Array, default: []
    });
    
    game.settings.register(RagnaroksRunar.ID, "pinnedMessages", {
        scope: "client", config: false, type: Object, default: {}
    });
    
    game.settings.register(RagnaroksRunar.ID, "enableDesktopNotifications", {
